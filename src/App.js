        ...
        <div className="App">
            <AppContext.Provider value={{toggleClass: toggleClass}}>
                ...
                <div
                    className={
                        !isActive
                            ? "sidebar fixed top-0 bottom-0 lg:left-0 left-[-300px] p-2 w-[300px]" +
                            " overflow-y-auto text-center bg-white"
                            : "left-[-300px]"
                    }
                >
                    <div className="text-gray-100 text-xl">
                        <div className="p-2.5 items-center w-24` h-56">
                            <img className={"rounded-full object-cover mx-auto mt-16"}
                                 src={userImage} width={86} height={60} alt=""/>
                        </div>
                    </div>
                    <div className="text-gray-900 text-[15px] mt-1">Steve Yonkeu</div>
                    <div
                        ...
                        <span className="text-[16px] ml-4 font-bold uppercase">
                            Home
                        </span>
                    </div>
                    <div
                        ...
                        <span className="text-[16px] ml-4 text-blue-400 font-bold uppercase">
                            Chat
                        </span>
                    </div>
                    <div
